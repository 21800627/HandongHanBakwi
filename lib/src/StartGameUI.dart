...
class StartGameScreen extends StatelessWidget{
  ...
  StartGameScreen({Key? key, required this.roundNum, required this.roundStep, required this.playerNum})
      : super(key: key);
  ...
  Future<int> _rollDice(context,model,board) async{
    if(!model.isGameOver()){
      await diceKey.currentState?.rollDice().then((value){
        ...
        Player result = model.setPlayerGameOver();
        board.setPlayerOnTile(result);
